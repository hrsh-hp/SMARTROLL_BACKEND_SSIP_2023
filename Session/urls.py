...
from .views import create_lecture_session, mark_attendance_for_student,get_session_data_for_export,mark_attendance_for_absent_student,authenticate_teacher
urlpatterns = [     
    ...
    path('authenticate_teacher/',authenticate_teacher,name='authenticate_teacher'),
]