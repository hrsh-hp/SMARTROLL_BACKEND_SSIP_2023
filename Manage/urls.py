...
from .views import get_active_terms_for_superadmin,get_object_counts,add_semester,get_semesters,add_division,add_batch,get_batches,get_divisions,add_teacher,get_teachers,get_subjects,add_subject,get_timetable,get_lecture_configs,add_lecture_to_schedule,upload_students_data,get_terms,add_term,get_timetable_for_teacher,get_timetable_for_student,get_subjects_of_teacher,get_lecture_sessions_for_teacher,activate_teacher_acount,add_lecture_as_proxy,set_web_push_subscription,save_web_push_subscription,set_new_password_for_student,get_subjects_of_teacher_by_admin,get_lecture_sessions_for_teacher_by_admin,get_branches_of_teacher,get_semesters_from_branch,get_divisons_from_semesters,get_batches_from_divison,get_batches_from_semester,get_batches_from_subject,get_subjects_of_student,upload_master_timetable,get_streams,get_divisions_from_stream,get_semesters_from_stream,add_subjects_to_semester,get_subjects_from_acedemic_year,get_teachers_subject_choices,get_students_subject_choices,mark_subject_choices,get_complementry_subject_from_semester,get_teachers_for_the_subject,get_students_for_the_subject,unlock_subject_choices,get_semesters_only_from_stream,get_subject_choice_groups,get_division_suggestion,unlock_subject_choice_for_student,confirm_suggested_divisions
urlpatterns = [        
    ...
    path('get_semesters_from_stream/<str:stream_slug>',get_semesters_from_stream,name='get_semesters_from_stream'),
    path('get_semesters_only_from_stream/<str:stream_slug>',get_semesters_only_from_stream,name='get_semesters_only_from_stream'),
    ...
    path('get_complementry_subject_from_semester/<str:semester_slug>',get_complementry_subject_from_semester,name='get_students_subget_complementry_subject_from_semesterject_choices'),
    path('mark_subject_choices/',mark_subject_choices,name='mark_subject_choices'),
    path('get_teachers_for_the_subject/<str:subject_slug>',get_teachers_for_the_subject,name='get_teachers_for_the_subject'),
    path('get_students_for_the_subject/<str:subject_slug>',get_students_for_the_subject,name='get_students_for_the_subject'),
    path('unlock_subject_choices/',unlock_subject_choices,name='unlock_subject_choices'),
    path('get_subject_choice_groups/<str:semester_slug>',get_subject_choice_groups,name='get_subject_choice_groups'),
    path('unlock_subject_choice_for_student/',unlock_subject_choice_for_student,name='unlock_subject_choice_for_student'),
    path('get_division_suggestion/<str:semester_slug>',get_division_suggestion,name='get_division_suggestion'),
    path('confirm_suggested_divisions/',confirm_suggested_divisions,name='confirm_suggested_divisions'),
